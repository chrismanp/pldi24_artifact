...
if [ ! -d /home/user/lazyDir/cilkbench ]; then
    echo "Creating directory /home/user/lazyDir/cilkbench"
    cp -r /home/user/cilkbench /home/user/lazyDir/
fi

if [ ! -d /home/user/lazyDir/pbbsbench ]; then
    echo "Creating directory /home/user/lazyDir/pbbsbench"
...
if [ ! -d /home/user/lazyDir/opencilk ]; then
    echo "Creating directory /home/user/lazyDir/opencilk"
